...
const App = () => {
  ...
  if (fetchingToken) return <>Loading......</>;
    ...
    <React.Fragment>
      ...
      <Switch>
        ...
        <Route
          exact
          path="/join"
          render={() => <AnonymousRoute component={RegisterPage} />}
        />
        <Route
          exact
          path="/signup/email/verify/:key"
          render={() => <AnonymousRoute component={ActivateAccount} />}
        />
        <Route exact path="/user/:query" render={() => <Settings />} />
        <Route
          path="/login/:query?"
          render={() => <AnonymousRoute component={LoginPage} />}
        />
        <Route
          exact
          path="/logout"
          render={() => (
            <ProtectedRoute redirectTo="/login" component={Logout} />
          )}
        />
        <Route
          exact
        ...
        <Route
          ...
          path="/new"
          render={() => (
            <ProtectedRoute redirectTo="/login" component={NewCourse} />
          )}
        />
        <Route
          exact
          path="/courses/invitations/:token"
          render={() => (
        ...
        <Route
          exact
          path="/:owner/:code/:type_1?/:title_1?/:type_2?/:title_2?"
          render={() => (
            <ProtectedRoute redirectTo="/login" component={CoursePage} />
          )}
        />
