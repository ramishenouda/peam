...
export const AddRequirement = () => {
    ...
    CreateRequirement(
      ...
      .then((result) => {
        ...
        disPatch(
          updateCourse({
            ...courseState,
            requirements: [...courseState.requirements, requirement],
          })
        );
      })
      .catch((err) => {
  ...
  return (
    <Container>
      <div>
        <h1 className="f2 mb-4">Project requirement</h1>
        <p className="f3">
          A project requirement is where the students can submit their projects.
          it also contains information like the start date of submitting the
          projects, end date, and other information that could be added in the
          description.
        </p>
      </div>
      <div className="mt-4">
        <h1 className="f2 title">Add a project requirement</h1>
        <hr />
      </div>
      <div className="mt-2">
