  ...
  const submit = () => {
    ...
    UpdateCourseAttachment(
      ...
      .then(() => {
        ...
        const attachmentIndex = courseState.attachments.findIndex(
        ...
        .then(() => {
          dispatch(
            updateCourse({
              ...courseState,
              attachments: [
                ...courseState.attachments.filter(
                  (item) => item.uid !== props.data.uid
                ),
              ],
            })
          );
  ...
  return (
    <Form className="p-3 mb-2" onSubmit={handleSubmit(() => submit())}>
      ...
      <Form.Group controlId="link">
        <Form.Label className="f3">
          Link <span className="required-text">*</span>
        </Form.Label>
        <Form.Control
          className="f3"
          type="text"
