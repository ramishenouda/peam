...
export const SettingsNavbar = (props: Props) => {
    return (
        <Navbar className="mt-3 mb-1">
            <NavItem onClick={() => props.setTab(0)} className={`${props.active === 0 && 'highlighted-text'} mx-auto`}>
                <ProfileIcon className="offset-icon"/> Profile
            </NavItem>
            <NavItem onClick={() => props.setTab(1)} className={`${props.active === 1 && 'highlighted-text'} mx-auto`}>
                <SecurityIcon className="offset-icon"/> Security
            </NavItem>
            <NavItem onClick={() => props.setTab(2)} className={`${props.active === 2 && 'highlighted-text'} mx-auto`}>
                <CoursesIcon className="offset-icon"/> Courses
            </NavItem>
            <NavItem onClick={() => props.setTab(3)} className={`${props.active === 3 && 'highlighted-text'} mx-auto`}>
