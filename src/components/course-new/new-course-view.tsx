        ...
        <Container className="mt-2">
            <header>
                <p className="f3">
                    ...
                    You can create projcet requirements, and allow your students to upload their projects.
                </p>
                <div className="mt-4">
                ...
                <div className="mt-2">
                    <Form className="" onSubmit={handleSubmit(() => submit())}>
                        <Form.Group controlId="title">
                            <FormLabel className="f3">Title <span className="required-text">*</span></FormLabel>
                            <FormControl
                                className="f2"
                                type="text"
                                autoComplete="off"
                        ...
                        <Form.Group controlId="code">
                            <FormLabel className="f3">Code <span className="required-text">*</span></FormLabel>
                            <FormControl
                                className="f2"
                                type="text"
                                autoComplete="off"
